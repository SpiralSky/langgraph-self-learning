...
export function ThreadActionsView({
  ...
  const [addressedActions, setAddressedActions] = useState<Map<number, Decision>>(
    new Map(),
  );
  ...
  const handleApproveAll = useCallback(() => {
    ...
    try {
      ...
      const command: Command = { resume: { decisions: allDecisions } };
  ...
  }, [actionRequests, hasMultipleActions, sendCommand]);
  ...
  }, [actionRequests, addressedActions, hasMultipleActions, sendCommand]);
