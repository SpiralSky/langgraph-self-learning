...
import { WidgetRenderer } from "@/components/thread/widget-renderer";
...
/**
 * Markdown — renders a markdown string exactly like the text outside widgets.
 *
 * The input is split into plain markdown and `:::` widget segments (via
 * `parseWidgetFences`), each rendered through the same react-markdown
 * pipeline (GFM, math, KaTeX and the shared component styles) or the
 * `WidgetRenderer` respectively. Widget bodies get the same treatment, so
 * they support markdown just like regular chat text.
 *
